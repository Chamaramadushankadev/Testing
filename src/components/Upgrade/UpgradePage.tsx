...
import { Check, Star, Zap, Users, Mail, Palette, BarChart3, Crown, ArrowRight, Sparkles } from 'lucide-react';
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 dark:text-gray-400 mb-8 max-w-3xl mx-auto">
            Choose the perfect plan to unlock powerful features and take your productivity to the next level
          </p>
          ...
          {packages.map((pkg) => {
            ...
            return (
              <div
                ...
                } p-8 transition-all duration-300 hover:shadow-2xl hover:scale-105`}
              >
                {pkg.popular && (
