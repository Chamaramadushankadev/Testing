...
export const ClientManagement: React.FC = () => {
  ...
  return (
    <div className="space-y-6">
      <div>
        <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-4">Client Management</h3>
        <p className="text-gray-600 dark:text-gray-400 mb-6">Manage your clients and track their projects across all modules</p>
      </div>
